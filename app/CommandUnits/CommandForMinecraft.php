...
class CommandForMinecraft extends CommandForWebsocket
{
    ...
    protected function getShopSellEntryStart()
    {
        return function(ParameterForMinecraft $p_param): ?string
        {
            ...
            $cmd = null;
            if($cnf_sell['id'] === 'rifle_cannon')
            {
                $cmd = 'clear @s[hasitem={item=customize:rifle_cannon,location=slot.weapon.mainhand}] customize:rifle_cannon 0 1';
            }
            if($cnf_sell['id'] === 'light_sword')
            {
                $cmd = 'clear @s[hasitem={item=customize:light_sword,location=slot.weapon.mainhand}] customize:light_sword 0 1';
            }
            ...
            if($cnf_sell['id'] === 'explode_sword')
            {
                $cmd = 'clear @s[hasitem={item=customize:explode_sword,location=slot.weapon.mainhand}] customize:explode_sword 0 1';
            }
            if($cmd !== null)
            {
